...
//List<Cfinvsrvanx> searchServicesForAddService(
//    @Param("companyId") String companyId, 
//    @Param("branchId") String branchId, 
//    @Param("searchValue") String searchValue, 
...
//	
//	@Modifying
//	@Query("UPDATE AssessmentSheet SET comments = :comments, intComments = :intComments "
...
//			+ "from AssessmentSheet a "
//	        + "LEFT OUTER JOIN Cfinvsrvanx c ON a.companyId = c.companyId AND a.branchId = c.branchId AND a.assesmentId = c.processTransId AND a.containerNo = c.containerNo "
