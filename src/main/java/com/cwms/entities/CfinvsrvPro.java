...
@Entity
@Table(name="cfinvsrvpro")
@IdClass(CfinvsrvId.class)
public class CfinvsrvPro {
		...
		public CfinvsrvPro(String invoiceNo, String branchId, String companyId, String partyId, String profitcentreId,
...
//		Export Container Invoice
		public CfinvsrvPro(BigDecimal billAmt, BigDecimal invoiceAmt, BigDecimal receiptAmt, String partyId)
	    {
	    	this.billAmt = billAmt;
	    	this.invoiceAmt = invoiceAmt;
	    	this.receiptAmt = receiptAmt;
