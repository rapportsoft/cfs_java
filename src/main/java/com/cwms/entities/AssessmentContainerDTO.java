...
public class AssessmentContainerDTO implements Cloneable {
	...
	public AssessmentContainerDTO(String containerNo, String containerSize, String containerType, Date gateInDate,
			...
			String ssrTransId, String serviceUnit, String executionUnit, String serviceUnit1, String executionUnit1,
			String currencyId, BigDecimal discPercentage, BigDecimal discValue, BigDecimal mPercentage,
			BigDecimal mAmount, String woNo, String woAmndNo, String criteria, BigDecimal rangeFrom, BigDecimal rangeTo,
			String containerStatus, String gateOutId, String gatePassNo, String taxApp, String acCode,
			BigDecimal serviceRate, BigDecimal taxPerc, String taxId, BigDecimal exRate, String serviceGroup) {
