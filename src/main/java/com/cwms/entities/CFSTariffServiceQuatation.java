...
@Entity
@Table(name = "cfstdtrfsrvquatation")
@IdClass(CfstdtrfsrvId.class)
public class CFSTariffServiceQuatation implements Cloneable
{
		...
		public CFSTariffServiceQuatation(String companyId, String branchId, String finYear, String cfsTariffNo,
		...
		public CFSTariffServiceQuatation() {
			super();
		...
		public CFSTariffServiceQuatation(String serviceId, BigDecimal rate) {
			super();
			this.serviceId = serviceId;
			this.rate = rate;
		}
...
//		For Tariff Report
		public CFSTariffServiceQuatation(BigDecimal srNo, String containerSize, String commodityCode, String cargoType, String rangeType,
