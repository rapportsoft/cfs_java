...
@Table(name = "cfstdtrfap")
public class VendorTariff implements Cloneable {
	@Id
	...
	public VendorTariff(String companyId, String branchId, String finYear, String profitCentreId, String cfsTariffNo,
	...
	public VendorTariff(String cfsTariffNo, String cfsAmndNo, String contractName) {
		super();
		this.cfsTariffNo = cfsTariffNo;
		this.cfsAmndNo = cfsAmndNo;
		this.contractName = contractName;
	...
	public String toString() {
		return "VendorTariff [companyId=" + companyId + ", branchId=" + branchId + ", finYear=" + finYear
	...
	public VendorTariff(String cfsTariffNo, String cfsAmndNo, String status, String ammendStatus) {
		super();
		this.cfsTariffNo = cfsTariffNo;
		this.cfsAmndNo = cfsAmndNo;
		this.status = status;
	...
	public VendorTariff(String partyId, String status, String contractName, String shippingLine, String cha,
			String importerId, String exporterId, String shippingAgent, String forwarderId, String consolerId,
...
// AuditTrail Report
	...
	public VendorTariff(String cfsTariffNo, String cfsAmndNo, String contractName, String partyName,
