...
@Entity
@Table(name="cfassesmentsheetap")
@IdClass(AssessmentSheetId.class)
public class AssessmentSheetAP implements Cloneable {
	 @Id
...
//	    private String creditAllowed;
		...
		public AssessmentSheetAP(String assesmentId, String companyId, String branchId, String assesmentLineNo,
...
//		Export Container Invoice
		...
		public String getProfitcentreName() {
			...
			public AssessmentSheetAP(String companyId, String branchId, String assesmentId, String assesmentLineNo,
		...
		this.partyId = partyId;	
			...
			public AssessmentSheetAP(String companyId, String branchId, String assesmentId, String assesmentLineNo,Date assesmentDate, String containerNo, String containerSize, String containerType, Date gateInDate, Date invoiceDate,
