...
@Entity
@Table(name = "invcredittrckap")
@IdClass(InvCreditTrackId.class)
public class InvCreditTrackAP {
	@Id
	...
	public InvCreditTrackAP() {
		super();
		// TODO Auto-generated constructor stub
	}

	public InvCreditTrackAP(String companyId, String branchId, String partyId, String transId, String invoiceNo,
