...
@Entity
@Table(name = "cfstdtrfsrvap")
@IdClass(CfstdtrfsrvId.class)
public class VendorTariffSrv  implements Cloneable {
	 @Id
		...
		public VendorTariffSrv(String companyId, String branchId, String finYear, String cfsTariffNo,
		...
		public VendorTariffSrv(String serviceId, BigDecimal rate) {
			super();
			this.serviceId = serviceId;
			this.rate = rate;
		}
...
//		For Tariff Report
		public VendorTariffSrv(BigDecimal srNo, String containerSize, String commodityCode, String cargoType, String rangeType,
