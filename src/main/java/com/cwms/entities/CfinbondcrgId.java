...
public class CfinbondcrgId implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(companyId, that.companyId) && Objects.equals(branchId, that.branchId)
				&& Objects.equals(finYear, that.finYear) && Objects.equals(inBondingId, that.inBondingId)
				&& Objects.equals(inBondingHdrId, that.inBondingHdrId)
				&& Objects.equals(profitcentreId, that.profitcentreId) && Objects.equals(nocTransId, that.nocTransId)
				&& Objects.equals(nocNo, that.nocNo);
	}

	@Override
	public int hashCode() {
		return Objects.hash(companyId, branchId, finYear, inBondingId, inBondingHdrId, profitcentreId, nocTransId,
				nocNo);
	}
}
