...
@Entity
@Table(name = "generaldeliverygrid")
@IdClass(GeneralDeliveryGridId.class)
public class GeneralDeliveryGrid {
	...
	public String toString() {
		return "GeneralDeliveryGrid [deliveryId=" + deliveryId + ", boeNo=" + boeNo + ", srNo=" + srNo
				+ ", yardLocation=" + yardLocation + ", yardBlock=" + yardBlock + ", blockCellNo=" + blockCellNo
				+ ", companyId=" + companyId + ", branchId=" + branchId + ", receivingId=" + receivingId
