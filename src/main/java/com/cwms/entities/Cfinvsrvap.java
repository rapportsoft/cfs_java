...
@Entity
@Table(name = "cfinvsrvap")
@IdClass(CfinvsrvId.class)
public class Cfinvsrvap {
	@Id
	...
	public Cfinvsrvap(String invoiceNo, String branchId, String companyId, String partyId, String profitcentreId,
...
//		Export Container Invoice
	public Cfinvsrvap(BigDecimal billAmt, BigDecimal invoiceAmt, BigDecimal receiptAmt, String partyId)
	    {
	    	this.billAmt = billAmt;
	    	this.invoiceAmt = invoiceAmt;
	    	this.receiptAmt = receiptAmt;
