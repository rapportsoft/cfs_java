...
@Entity
@Table(name="fintransadj")
@IdClass(FinTransId.class)
public class FinTransAdj {
	...
	public FinTransAdj(String companyId, String branchId, String docType, String ledgerType, BigDecimal lineId,
			...
			Date approvedDate, String billingParty, String importerId, int impSrNo, String status, String assesmentId,
			String recordType, String oldInvoiceNo, String cnAdjustFlag, String oldOprAdjTransId,
			Date oldOprAdjTransDate, BigDecimal credAmtAdj, String isOnAccPay, String customerLedgerFlag,
			String partyGst, String partyName, String partyAddress1, String partyAddress2, String partyAddress3,
			BigDecimal advanceAmt, BigDecimal advanceClearedAmt) {
