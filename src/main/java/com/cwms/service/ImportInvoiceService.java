...
public class ImportInvoiceService {
	...
	public Map<String, String> getInvoiceDetails(String companyId, 
        ...
        Object result = importinvoicerepo.getInvoiceDetailsNew(companyId,branchId, invoiceNo);
...
//        	invDtl.put("sez",(String)fields[43]);   
//        	invDtl.put("taxApplicable",(String)fields[42]);  
        	
        	invDtl.put("sez", String.valueOf(fields[43]));   
        	invDtl.put("taxApplicable", String.valueOf(fields[42]));
...
//        	invDtl.put("sez",(String)fields[30]);    how to convert char to String 
	...
	public Map<String, String> getCompanyAddressDetails( String branchId, 
		...
		Object companyDtl = importinvoicerepo.getCompanyAddressDetailsNew(branchId, companyId);
		...
		if(companyDtl!=null) {
        	...
        	company.put("lotNo",(String) fields[19]);
        	company.put("lotDate",(String) fields[20]);
