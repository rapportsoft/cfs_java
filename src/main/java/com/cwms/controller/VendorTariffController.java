...
import com.cwms.service.VendorTariffService;

@RestController
@RequestMapping("/vendorTarrif")
@CrossOrigin("*")
public class VendorTariffController {
	@Autowired
	public VendorTariffService tariffService;
	...
	public ResponseEntity<?> ammendTariff(@RequestParam("companyId") String companyId,
			@RequestParam("branchId") String branchId, @RequestBody CfsTarrif cfsTariff, @RequestParam("userId") String user) {
	...
	public ResponseEntity<?> addHeaderCfsTariff(@RequestParam("companyId") String companyId,
			@RequestParam("branchId") String branchId, @RequestBody VendorTariff cfsTariff,
	...
	public ResponseEntity<?> getSingleService(@RequestParam("companyId") String companyId,
		...
		try {
			List<VendorTariffSrv> selectedService = tariffService.getSingleService(companyId, branchId, serviceId, tariffNo, cfsAmndNo);
