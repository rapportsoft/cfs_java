...
@CrossOrigin("*")
@RequestMapping("/importinvoiceproformaprint")
@RestController
public class ImportInvoiceProformaPrintController {

	@Autowired
	ImportInvoiceProformaPrintService importinvoiceservice;
...
//			System.out.println("total Cal "+TotalCal.toString());
		...
		String htmlContent = templateEngine.process("importInvoicePrintproforma.html", context);
//
