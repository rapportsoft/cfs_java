...
@CrossOrigin("*")
@RequestMapping("/exportproformaprint")
@RestController
public class ExportProformaPrintController {
	
	@Autowired
	private TemplateEngine templateEngine;
	
	@Autowired
	private ExportProformaPrintService exportproformaprintservice;
	...
	public ResponseEntity<?> generateInvoicePdf(@PathVariable("cid") String cid, @PathVariable("bid") String bid ,@PathVariable("invoiceNo") String invoiceNo,
		...
		Map<String,String> compdtl = exportproformaprintservice.getCompanyAddressDetails(bid,cid);
		System.out.println(compdtl.toString());
		String branchAddress = compdtl.get("baddr1")+" "+compdtl.get("baddr2")+" "+compdtl.get("baddr3");
		
		Map<String,String> invdtl = exportproformaprintservice.getInvoiceDetails(cid, bid,invoiceNo);
...
//						 String finalamtI1 =String.format("%.2f",finalamt);
						 ...
						 boolean isMatch = exportproformaprintservice.sacNoAndTaxpercMatch(sac,taxperc1.trim() ,itemList );
...
//			System.out.println("total Cal "+TotalCal.toString());
		...
		Map<String,List<Map<String,String>>> conSbDtl = exportproformaprintservice.getContainerAndSbDetails(cid, bid, sbTransID, assesmentId);
	...
	public ResponseEntity<?> generateInvoicePdfcarting(@PathVariable("cid") String cid, @PathVariable("bid") String bid ,@PathVariable("invoiceNo") String invoiceNo,
		...
		Map<String,String> compdtl = exportproformaprintservice.getCompanyAddressDetails(bid,cid);
		Map<String,String> invdtl = exportproformaprintservice.getcartingInvoiceDetails(cid, bid,invoiceNo);
//		System.out.println(compdtl.toString());
		String branchAddress = compdtl.get("baddr1")+" "+compdtl.get("baddr2")+" "+compdtl.get("baddr3");
		String billingPartyAddress = invdtl.get("billingPartyAddress1")+" "+invdtl.get("billingPartyAddress2")+" "+invdtl.get("billingPartyAddress3");
...
//			System.out.println("total Cal "+TotalCal.toString());
		...
		// sb details
		List<Map<String,String>> cartsblist = exportproformaprintservice.getCartingSbDetails(cid, bid, assesmentId);
		...
		String htmlContent = templateEngine.process("ExportInvoicecartingPrintproforma.html", context);
		//
				ITextRenderer renderer = new ITextRenderer();
				renderer.setDocumentFromString(htmlContent);
				renderer.layout();
...
//			System.out.println("total Cal "+TotalCal.toString());
		...
		Map<String,List<Map<String,String>>> conSbDtl = exportproformaprintservice.getContainerAndSbDetailsbackttown(cid, bid, sbTransID, assesmentId);
