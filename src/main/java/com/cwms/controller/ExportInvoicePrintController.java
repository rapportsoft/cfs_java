...
@CrossOrigin("*")
@RequestMapping("/exportinvoiceprint")
@RestController
public class ExportInvoicePrintController {
	
	@Autowired
	ExportInvoicePrintService exportinvoiceprintService;
	...
	public ResponseEntity<?> generateInvoicePdf(@PathVariable("cid") String cid, @PathVariable("bid") String bid ,@PathVariable("invoiceNo") String invoiceNo,
			@PathVariable("assesmentId") String assesmentId , @PathVariable("sbTransID") String sbTransID) throws DocumentException{
		
		System.out.println("inside export invoice controller ");
		System.out.println(cid+" "+bid);
		

		Map<String,String> compdtl = exportinvoiceprintService.getCompanyAddressDetails(bid,cid);
		System.out.println(compdtl.toString());
		String branchAddress = compdtl.get("baddr1")+" "+compdtl.get("baddr2")+" "+compdtl.get("baddr3");
		
		Map<String,String> invdtl = exportinvoiceprintService.getInvoiceDetails(cid, bid,invoiceNo);
		...
		String chaAddress =  invdtl.get("chaAddress1")+" "+invdtl.get("chaAddress2")+" "+invdtl.get("chaAddress2");
		if(chaAddress.contains("null"))
			chaAddress="";
...
//		context.setVariable("invoicevalDate", invdtl.get("invoicevalDate"));
		...
		// payment details 
		List<Object[]> paydtl = exportinvoiceprintRepo.getPaymentDetails(cid, bid,invoiceNo);
		String creditFlag ="";
...
//    	    recievedpayment = String.format("%.2f",sum3);
		...
		Object bankdtl = exportinvoiceprintRepo.getBankDetails(cid, bid);
		if (bankdtl != null) {
		...
		List<Map<String,String>> itemList = exportinvoiceprintService.getDetailsOfBill(cid, bid, invoiceNo);
		if(!itemList.isEmpty()) {
...
//			System.out.println("total Cal "+TotalCal.toString());
		...
		Map<String,List<Map<String,String>>> conSbDtl = exportinvoiceprintService.getContainerAndSbDetails(cid, bid, sbTransID, assesmentId);
		
		System.out.println("sbcon"+conSbDtl);
		context.setVariable("sbList",conSbDtl.get("sbList"));
		context.setVariable("conList",conSbDtl.get("conList"));
		
		System.out.println("sbList" + conSbDtl.get("sbList") );
	...
	@PostMapping("/printinvoicepdfcarting/{cid}/{bid}/{invoiceNo}/{assesmentId}/{sbTransID}")
	public ResponseEntity<?> generateInvoicePdfcarting(@PathVariable("cid") String cid, @PathVariable("bid") String bid ,@PathVariable("invoiceNo") String invoiceNo,
			@PathVariable("assesmentId") String assesmentId , @PathVariable("sbTransID") String sbTransID) throws DocumentException{
		
		Map<String,String> compdtl = exportinvoiceprintService.getCompanyAddressDetails(bid,cid);
		Map<String,String> invdtl = exportinvoiceprintService.getcartingInvoiceDetails(cid, bid,invoiceNo);
//		System.out.println(compdtl.toString());
		String branchAddress = compdtl.get("baddr1")+" "+compdtl.get("baddr2")+" "+compdtl.get("baddr3");
		String billingPartyAddress = invdtl.get("billingPartyAddress1")+" "+invdtl.get("billingPartyAddress2")+" "+invdtl.get("billingPartyAddress3");
		String Agaddress =  invdtl.get("AgAddress1")+" "+invdtl.get("AgAddress1")+" "+invdtl.get("AgAddress1");
		if(Agaddress.contains("null"))
			Agaddress="";
		...
		context.setVariable("billingPartyAddress", billingPartyAddress);
		context.setVariable("Agaddress", Agaddress);
		context.setVariable("invoiceNo",invoiceNo );
		context.setVariable("invoiceDate", invdtl.get("invoiceDate"));
//		context.setVariable("invoicevalDate", invdtl.get("invoicevalDate"));
//		context.setVariable("shippingLine", invdtl.get("shippingLine"));
...
//			System.out.println("total Cal "+TotalCal.toString());
		...
		// sb details
		List<Map<String,String>> cartsblist = exportinvoiceprintService.getCartingSbDetails(cid, bid, assesmentId);
		context.setVariable("cartsblist", cartsblist);
...
//		    	    recievedpayment = String.format("%.2f",sum3);
		...
		String htmlContent = templateEngine.process("ExportInvoicecartingPrint.html", context);
		//
				ITextRenderer renderer = new ITextRenderer();
				renderer.setDocumentFromString(htmlContent);
				renderer.layout();
	...
	@PostMapping("/printinvoicepdfbackttown/{cid}/{bid}/{invoiceNo}/{assesmentId}/{sbTransID}")
	public ResponseEntity<?> generateInvoicePdfbackttown(@PathVariable("cid") String cid, @PathVariable("bid") String bid ,@PathVariable("invoiceNo") String invoiceNo,
			@PathVariable("assesmentId") String assesmentId , @PathVariable("sbTransID") String sbTransID) throws DocumentException{
...
//			System.out.println("total Cal "+TotalCal.toString());
		...
		Map<String,List<Map<String,String>>> conSbDtl = exportinvoiceprintService.getContainerAndSbDetailsbackttown(cid, bid, sbTransID, assesmentId);
