...
public class TarrifController {
	...
	@Autowired
	public Tarrifservice tariffService;
	...
	public ResponseEntity<?> addHeaderCfsTariff(@RequestParam("companyId") String companyId,
			@RequestParam("branchId") String branchId, @RequestBody CfsTarrif cfsTariff,
	...
	public ResponseEntity<?> getSingleService(@RequestParam("companyId") String companyId,
		...
		try {
			List<CFSTariffService> selectedService = tariffService.getSingleService(companyId, branchId, serviceId, tariffNo, cfsAmndNo);
