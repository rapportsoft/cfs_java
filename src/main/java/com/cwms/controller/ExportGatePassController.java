...
System.out.println("gatePass.getGatePassId() : "+gatePass.getGatePassId());
		if (gatePass.getGatePassId().isEmpty() || gatePass.getGatePassId() == null) {
			int sr = 1;
			
			System.out.println("multipleGatePass : "+multipleGatePass);
...
//			for loop end
			...
			System.out.println("Here 3" + result);
...
//			Update start
		...
		{
			System.out.println("Error in saveing Gate Pass : " + e);
			return null;
		}
	}
